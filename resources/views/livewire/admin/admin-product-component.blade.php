                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="confirm('Are you sure, You went to delete this product?') || event.stopImmediatePropagation()" style="margin-left:10px;"  wire:click.prevent="deleteProduct({{$product->id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
