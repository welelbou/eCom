            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Gérer les categories en page d'accueil
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateHomeCategory">
                            <div class="form-group">
                                <label class="col-md-4 control-label">Choisir des categories</label>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Numero de produit</label>
                                <div class="col-md-4">
