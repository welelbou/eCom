<main id="main">
    <div class="container">
                ...
                @foreach ($sliders as $slide)
                  <div class="item-slide">
                      ...
                      <div class="slide-info slide-1">
                          ...
                          <p class="sale-info">Only price: <span class="price">{{$slide->price}} MRU</span></p>
            ...
            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                ...
                <div class="product product-style-2 equal-elem ">
                    ...
                    <div class="product-info">
                        ...
                        <div class="wrap-price"><ins><p class="product-price">{{$sproduct->sale_price}} MRU</p></ins> <del><p class="product-price">{{$sproduct->regular_price}} MRU</p></del></div>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="wrap-show-advance-info-box style-1">
            <h3 class="title-box">Dernier Produits</h3>
                                ...
                                @foreach ($lproducts as $lproduct)
                                   ...
                                   <div class="product product-style-2 equal-elem ">
                                       ...
                                       <div class="product-info">
                                           ...
                                           <div class="wrap-price"><span class="product-price">{{$lproduct->regular_price}} MRU</span></div>
                                       </div>
                                   </div>
                                @endforeach
                            </div>
                                ...
                                @endphp
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">{{$c_product->regular_price}} MRU</span></div>
                                        </div>
                                    </div>
                                    @endforeach
                            </div>
