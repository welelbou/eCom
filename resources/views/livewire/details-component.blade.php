                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                            <div class="wrap-price">
                                <span class="product-price">{{$product->sale_price}} MRU</span>
                                <del><span class="product-price regprice">{{$product->regular_price}} MRU</span></del>
                            </div>
                        @else
                    ...
                    <div class="advance-info">
                        <div class="tab-control normal">
                            ...
                            {{-- <ahref="#add_infomation"class="tab-control-item">AddtionalInfomation</a> --}}
                                                ...
                                                <div id="comment-20" class="comment_container"> 
                                                    ...
                                                    <div class="comment-text">
                                                        ...
                                                        <p class="meta"> 
                                                            ...
                                                            <span class="woocommerce-review__dash">t</span>
                        ...
                        <li class="product-item">
                            <div class="product product-widget-style">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span class="product-price">{{$p_product->regular_price}} MRU</span></div>
                                </div>
                            </div>
                        </li>
                        @endforeach
