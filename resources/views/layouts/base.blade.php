...
<body class="home-page home-01 ">
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: 0022245 24 32 10" href="#" ><span class="icon label-before fa fa-mobile"></span>Line directe: 0022245 24 32 10</a>
								</li>
							</ul>
						</div>
							...
							<ul>
								...
								<li class="menu-item lang-menu menu-item-has-children parent">
									...
									<ul class="submenu lang" >
										<li class="menu-item" ><a title="hungary" href="#"><span class="img label-before"><img src="assets/images/lang-hun.png" alt="lang-hun"></span>Arabic</a></li>
										<li class="menu-item" ><a title="german" href="#"><span class="img label-before"><img src="assets/images/lang-ger.png" alt="lang-ger" ></span>English</a></li>
										<li class="menu-item" ><a title="french" href="#"><span class="img label-before"><img src="assets/images/lang-fra.png" alt="lang-fre"></span>French</a></li>
										{{-- <liclass="menu-item"><atitle="canada"href="#"><spanclass="imglabel-before"><imgsrc="assets/images/lang-can.png"alt="lang-can"></span>Canada</a></li> --}}
									</ul>
								</li>
                                    ...
                                    @auth
										@if(Auth::user()->utype === 'ADM')
										    <li class="menu-item menu-item-has-children parent" >
											    ...
											    <ul class="submenu curency" >
												    <li class="menu-item" >
													    <a title="Dashboard" href="{{route('admin.dashboard')}}">Votre Compte</a>
													</li>
													<li class="menu-item" >
													...
													<li class="menu-item">
														<a title="Manage Home Categories" href="{{route('admin.homecategories')}}">Gérer les categories d'accueil</a>
													</li>
													<li class="menu-item">
													...
													<li class="menu-item">
														<a title="All Orders" href="{{route('admin.orders')}}">Tous les ordres</a>
													</li>
													<li class="menu-item">
														<a title="Contact Message" href="{{route('admin.contact')}}">Messages de contacts</a>
													</li>
													<li class="menu-item">
														<a title="Settings" href="{{route('admin.settings')}}">Paramétres</a>
													</li>
													<li class="menu-item">
										...
										@else
										    <li class="menu-item menu-item-has-children parent" >
											    ...
											    <ul class="submenu curency" >
												    <li class="menu-item" >
													    <a title="Dashboard" href="{{route('user.dashboard')}}">Votre compte</a>
													</li>
													<li class="menu-item" >
													    <a title="My Orders" href="{{route('user.orders')}}">Mes ordres</a>
													</li>
													<li class="menu-item" >
													    <a title="Change Password" href="{{route('user.changepassword')}}">Changer le mot de passe</a>
													</li>
													<li class="menu-item" >
														<a  href="{{route('logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Se déconnecter</a>
													</li>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="/shop" class="link-term mercado-item-title">Magasin</a>
								</li>
								<li class="menu-item">
									<a href="/cart" class="link-term mercado-item-title">Panier</a>
								</li>
								<li class="menu-item">
									<a href="/checkout" class="link-term mercado-item-title">Consulter les produits</a>
								</li>
								<li class="menu-item">
	...
	<script src="https://cdn.tiny.cloud/1/jwj1bcxse05wi0dvvngg8j9i56ze2d4otarirqa7vff8xtk7/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
